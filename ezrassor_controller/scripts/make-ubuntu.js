 ...
 * make-ubuntu.js
 *
 * Same main-field swap as make-mac.js, but targets the deb and rpm makers
 * for Linux packaging.  Run this on an Ubuntu/Linux host.
 *
 * Usage:  node scripts/make-ubuntu.js
 */
...
function setPkgMain(value) {
    ...
    console.log(`[make-ubuntu] package.json "main" → ${value}`);
}
